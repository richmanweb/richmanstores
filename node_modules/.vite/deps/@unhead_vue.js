...
function useScript(_input, _options) {
  ...
  const res = new Proxy(script, {
    get(_, k2) {
      const target = k2 in script ? script : script.proxy;
      if (k2 === "then" || k2 === "catch") {
...
// node_modules/@unhead/vue/dist/shared/vue.40986ab9.mjs
...
// node_modules/@unhead/vue/dist/shared/vue.65b7bcda.mjs
...
function useScript2(_input, _options) {
  ...
  if ((_a = head._scripts) == null ? void 0 : _a[key])
  ...
  script = useScript(input, options);
  if (scope) {
    const _registerCb = (key2, cb) => {
      ...
      const destroy = () => {
        var _a2;
        if (i) {
          (_a2 = script._cbs[key2]) == null ? void 0 : _a2.splice(i - 1, 1);
          i = null;
        }
      };
